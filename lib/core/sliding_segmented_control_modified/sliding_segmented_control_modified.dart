...
const double _kMinSegmentedControlHeight = 32.0;
...
class CupertinoSlidingSegmentedControlModified<T> extends StatefulWidget {
  ...
  /// in the [children] map.
  CupertinoSlidingSegmentedControlModified({
    Key? key,
  ...
  @override
  State<CupertinoSlidingSegmentedControlModified<T>> createState() =>
      _SegmentedControlState<T>();
}

class _SegmentedControlState<T>
    extends State<CupertinoSlidingSegmentedControlModified<T>>
    with TickerProviderStateMixin<CupertinoSlidingSegmentedControlModified<T>> {
  ...
  @override
  void didUpdateWidget(CupertinoSlidingSegmentedControlModified<T> oldWidget) {
    super.didUpdateWidget(oldWidget);
